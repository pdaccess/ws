...
func New(inventoryRepo *database.InventoryRepository, activityRepo *database.ActivityRepository, pasteRepo *database.PasteRepository, serviceSettingsRepo *database.ServiceSettingsRepository, vector ports.VectorGenerator) ports.Service {
	return &Impl{
